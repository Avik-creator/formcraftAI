...
const Overview = async () => {
  return (
    <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-12 gap-6 pb-8 ">
      ...
      <Suspense fallback={<InfoCardSkeleton className="col-span-full md:col-span-6 max-h-[400px]" />}>
        <FormCompletionRate />
      </Suspense>

      <Suspense fallback={<InfoCardSkeleton className="col-span-full md:[grid-column:7/14] max-h-[400px]" />}>
        <SubmissionsOvertime />
      </Suspense>
