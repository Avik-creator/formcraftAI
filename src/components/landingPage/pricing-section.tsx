    ...
    <div className="container mx-auto px-4 py-16">
        ...
        {plans.map((plan) => (
          <div
            ...
            <div className="space-y-4">
              {plan.name === "Pro" ? (
                isPro ? (
                  <Button className="w-full h-12 bg-gradient-to-r from-zinc-700 to-zinc-800 hover:from-zinc-600 hover:to-zinc-700 border-zinc-600/50 text-white font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-xl"> </Button>
                ) : (
      ...
      <div className="text-center mt-16">
        <div className="max-w-2xl mx-auto">
          ...
          <Button variant="ghost" className="bg-zinc-800/40 hover:bg-zinc-700/60 border border-zinc-700/50 text-zinc-300 hover:text-white px-8 py-3 rounded-lg transition-all duration-300" onClick={() => window.location.href = 'mailto:avikm744@gmail.com'}>Contact Support</Button>
        </div>
      </div>
    </div>
  );
