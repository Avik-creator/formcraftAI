...
const data = templates?.slice(0, 4)?.map((t, i) => ({
    id: t.name,
    title: t.name,
    description:
            ...
            >
                {data?.map((template) => (
                    ...
                    >
                        ...
                        <div className="p-4">
                            <h3 className="text-lg font-semibold mb-1 text-white group-hover:text-zinc-200">
                                {template.title}
                            </h3>
                            <p className="text-zinc-400 text-sm mb-3 group-hover:text-zinc-300">
